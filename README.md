# genpark-multilingual-avatar-lip-sync-video-compiler-skill
...
> **GenPark AI Agent Skill** -- Multilingual talking-head avatar and neural lip-sync video compiler (HeyGen style)
